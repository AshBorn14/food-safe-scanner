...
SECRET_KEY = 'django-insecure-ficek22s#o=7hth#f&(5s&2#e*qy%(f!d)$8bz7xy8-x$ku&4&'
...
ROOT_URLCONF = 'foodsafeScanner.urls'
...
WSGI_APPLICATION = 'foodsafeScanner.wsgi.application'
